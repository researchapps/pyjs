...
#
# See: code.google.com/p/ipaddr-py/
...
# The above doesn't work in pyjamas. No real bytes in pyjamas anyway.
_compat_has_real_bytes = False
...
class IPv4Address(_BaseV4, _BaseIP):
    ...
    def __str__(self):
        # Fix for pyjamas mro method inheritance bug
        return _BaseIP.__str__(self)
    ...
    def _explode_shorthand_ip_string(self, ip_str=None):
        ...
        if self._is_shorthand_ip(ip_str):
            ...
            for hextet in new_ip:
                ...
                # The line above is to complicated for pyjamas
                _h = '0' * (4 - len(hextet)) + hextet
                ret_ip.append(_h.lower())
            return ':'.join(ret_ip)
